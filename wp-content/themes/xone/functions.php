...
function sr_theme_setup() {
	...
	/* Load Text Domain */
	load_theme_textdomain('sr_xone_theme', get_template_directory(). '/languages');
	...
	/* Theme images sizes */
	add_image_size( 'portfolio-thumb', 540);
	add_image_size( 'portfolio-crop-thumb', 540, 320, true );
	add_image_size( 'single-portfolio-image-big', 1100);
	add_image_size( 'blog-thumb', 800);
	add_image_size( 'single-blog-image', 1100);
...
if( !function_exists( 'sr_register_menu' ) ) {
    function sr_register_menu() {
		register_nav_menus(
			array(
				'primary-menu' => __('Primary Menu', 'sr_xone_theme')
			));	
    }
}
...
if( !function_exists( 'sr_enqueue_scripts' ) ) {
    function sr_enqueue_scripts() {
		...
		wp_register_script('easy-opener', get_template_directory_uri() . '/files/js/jquery.easy-opener.min.js', 'jquery', '1.0', true);
		wp_register_script('fitvids', get_template_directory_uri() . '/files/js/jquery.fitvids.min.js', 'jquery', '1.0', true);
		wp_register_script('parallax', get_template_directory_uri() . '/files/js/jquery.parallax.min.js', 'jquery', '1.0', true);
		wp_register_script('scrollto', get_template_directory_uri() . '/files/js/jquery.scroll.min.js', 'jquery', '1.0', true);
		wp_register_script('owlcarousel', get_template_directory_uri() . '/files/js/jquery.owl.carousel.min.js', 'jquery', '1.0', true);
		wp_register_script('xone-form', get_template_directory_uri() . '/files/js/xone-form.js', 'jquery', '1.0', true);
		wp_register_script('xone-header', get_template_directory_uri() . '/files/js/xone-header.js', 'jquery', '1.0', true);
		wp_register_script('xone-loader', get_template_directory_uri() . '/files/js/xone-loader.js', 'jquery', '1.0', true);
		wp_register_script('scrollbar', get_template_directory_uri() . '/files/js/jquery.perfect.scrollbar.js', 'jquery', '1.0', true);
		wp_register_script('mousewheel', get_template_directory_uri() . '/files/js/jquery.mousewheel.js', 'jquery', '1.0', true);
		wp_register_script('script', get_template_directory_uri() . '/files/js/script.js', 'jquery', '1.0', true);
		
		// Register style
		wp_register_style('default-style', get_stylesheet_uri() , 'default-style', '1.4.1');
		...
		wp_register_style('easyopener-style', get_template_directory_uri() . '/files/css/easy-opener.css', 'easyopener-style', '1.0');
		...
		wp_register_style('scrollbar-style', get_template_directory_uri() . '/files/css/perfect.scrollbar.css', 'scrollbar-style', '3.2.1');
    	...
    	wp_enqueue_script('xone-header');
    	wp_enqueue_script('xone-loader');
		...
		wp_enqueue_style('easyopener-style');
		...
		// include dark if true
		if (get_option($sr_prefix.'_colorscheme') == 'dark') { 
		...
		if (get_option($sr_prefix.'_method') !== 'html') { 
			...
			function sr_custom_css() {
				...
				'.sr_custom_pagesettings().' '.sr_custom_style_color().' '.stripslashes(get_option($sr_prefix.'_customcss')).'</style>';
			}
