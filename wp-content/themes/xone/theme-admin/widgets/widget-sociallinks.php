...
class sr_sociallinks_widget extends WP_Widget {
	...
	function sr_sociallinks_widget() {
		...
		// Widget settings
		$widget_ops = array( 'classname' => 'sr_sociallinks_widget', 'description' => __('A widget that displays all Social links which have been activated.', 'sr_xone_theme') );
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base', 'sr-sociallinks-widget' );
		
		// Create widget
		$this->WP_Widget( 'sr_sociallinks_widget', __('SR - Social Links','sr_xone_theme'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		?>
			<ul class="socialmedia-widget" >
                    ...
                    <?php if($sr_forrst !== '') { echo '<li class="forrst"><a href="'.$sr_forrst.'" target="_blank"></a></li>'; }?>
                    <?php if($sr_thumblr !== '') { echo '<li class="thumblr"><a href="'.$sr_thumblr.'" target="_blank"></a></li>'; }?>
	...
	function form( $instance ) {
		...
		<p>
            <i><?php _e('Enter your social profile links including "http://"', 'sr_xone_theme'); ?></i>
		</p>
        ...
        <!-- Facebook -->
		<p>
		<label for="<?php echo $this->get_field_id( 'facebook' ); ?>"><?php _e('Facebook:', 'sr_xone_theme') ?></label>
        ...
        <!-- Twitter -->
		<p>
		<label for="<?php echo $this->get_field_id( 'twitter' ); ?>"><?php _e('Twitter:', 'sr_xone_theme') ?></label>
        ...
        <!-- Googleplus -->
		<p>
		<label for="<?php echo $this->get_field_id( 'googleplus' ); ?>"><?php _e('Google Plus:', 'sr_xone_theme') ?></label>
        ...
        <!-- pinterest -->
		<p>
		<label for="<?php echo $this->get_field_id( 'pinterest' ); ?>"><?php _e('Pinterest:', 'sr_xone_theme') ?></label>
        ...
        <!-- instagram -->
		<p>
		<label for="<?php echo $this->get_field_id( 'instagram' ); ?>"><?php _e('Instagram:', 'sr_xone_theme') ?></label>
        ...
        <!-- dribbble -->
		<p>
		<label for="<?php echo $this->get_field_id( 'dribbble' ); ?>"><?php _e('Dribbble:', 'sr_xone_theme') ?></label>
        ...
        <!-- vimeo -->
		<p>
		<label for="<?php echo $this->get_field_id( 'vimeo' ); ?>"><?php _e('Vimeo:', 'sr_xone_theme') ?></label>
        ...
        <!-- youtube -->
		<p>
		<label for="<?php echo $this->get_field_id( 'youtube' ); ?>"><?php _e('Youtube:', 'sr_xone_theme') ?></label>
        ...
        <!-- behance -->
		<p>
		<label for="<?php echo $this->get_field_id( 'behance' ); ?>"><?php _e('Behance:', 'sr_xone_theme') ?></label>
        ...
        <!-- deviantart -->
		<p>
		<label for="<?php echo $this->get_field_id( 'deviantart' ); ?>"><?php _e('Deviantart:', 'sr_xone_theme') ?></label>
        ...
        <!-- forrst -->
		<p>
		<label for="<?php echo $this->get_field_id( 'forrst' ); ?>"><?php _e('Forrst:', 'sr_xone_theme') ?></label>
        ...
        <!-- thumblr -->
		<p>
		<label for="<?php echo $this->get_field_id( 'thumblr' ); ?>"><?php _e('Thumblr:', 'sr_xone_theme') ?></label>
        ...
        <!-- linkedin -->
		<p>
		<label for="<?php echo $this->get_field_id( 'linkedin' ); ?>"><?php _e('Linked In:', 'sr_xone_theme') ?></label>
		<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'linkedin' ); ?>" name="<?php echo $this->get_field_name( 'linkedin' ); ?>" value="<?php echo $instance['linkedin']; ?>" />
         ...
         <!-- Rss -->
		<p>
		<label for="<?php echo $this->get_field_id( 'rss' ); ?>"><?php _e('Rss:', 'sr_xone_theme') ?></label>
